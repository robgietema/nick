...
We can use the `ics_view` endpoint to export the event content to a `.ics`-file to be used for external services. We can export the data by sending a GET request to the resource URL:
