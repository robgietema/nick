    ...
    >
      ...
      <Container>
        <Segment inverted className="discreet">
          <FormattedMessage
            id="Nick is copyright 2022 by Rob Gietema."
          ...
          <FormattedMessage
            ...
            values={{
              license: (
                <a
                  className="item"
                  href="http://creativecommons.org/licenses/MIT"
                >
                  <FormattedMessage
                    id="MIT License"
        ...
        <List horizontal inverted>
          ...
          <div role="listitem" className="item">
            <a className="item" href="https://nickcms.org">
              <FormattedMessage
                id="Powered by Nick & Volto"
                defaultMessage="Powered by Nick & Volto"
              />
            </a>
          </div>
        </List>
